...
const _handleNewLines = function (ace) {
...
exports.postToolbarInit = function (hook_name, context) {
    ...
    toolbar.registerCommand('addImage', function () {
        $(document).find('body').find('#imageInput').remove();
        const fileInputHtml = '<input style="width:1px;height:1px;z-index:-10000;" id="imageInput" type="file" />';
...
exports.aceDomLineProcessLineAttributes = function (name, context) {
    ...
    if (!imgType) return [];
    const line = context.domline.createDomLine();
